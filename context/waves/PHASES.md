...
| `2026-06-26-slate-implementation` | planned | Build WP-001..006 bottom-up, one work package per pulse (pulses 01–06). No code until executed. |

## Active wave
- `2026-06-26-slate-implementation` (all pulses defined; pending execution)
